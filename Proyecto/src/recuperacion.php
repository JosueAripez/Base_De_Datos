...
<head>
    ...
    <title>Plataforma de Prevención</title>
    ...
    <link href="./css/recuperacion.css" rel="stylesheet">
</head>
<body>
<nav class="navbar">
        <div class="logo">
    ...
    <div class="v87_155">
        <!-- Fondo o cabecera principal -->
        <div class="v87_156"></div>
        
        <!-- Elementos decorativos -->
        <div class="name"></div>
        <div class="v87_158"></div>
        
        <!-- Título principal -->
        <span class="v87_159">PLATAFORMA PREVENCIÓN<br>DEL EMBARAZO</span>
        
        <!-- Pregunta para usuarios existentes -->
        <span class="v87_160">¿Ya tienes una cuenta?</span>
