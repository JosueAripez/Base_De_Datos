    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="col-12 col-md-6">
            ...
            <form method="POST" action="" class="bg-light p-4 rounded shadow-sm">
                ...
                <div class="mb-3">
                    <label for="pwd" class="form-label">ID de Usuario</label>
                    <input type="number" class="form-control" id="id" name="id" min="10" max="100" placeholder="Ingrese su ID" required>
                </div>
                <div class="mb-3">
